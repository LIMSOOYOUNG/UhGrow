...
public class InputAmountPumpkinPanel extends JPanel {
	private static final Font Font = null;
	private JPanel inputAmountPumpkinPanel;
	private int userNo;
	...
	public InputAmountPumpkinPanel(int userNo) {
		this.userNo = userNo;
		this.cookingController = new CookingController();
		inputAmountPumpkinPanel = this;
