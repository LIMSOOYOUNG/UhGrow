...
public class InputAmountCornPanel extends JPanel {
	private static final Font Font = null;
	private JPanel inputAmountCornPanel;
	private int userNo;
	...
	public InputAmountCornPanel(int userNo) {
		this.userNo = userNo;
		this.cookingController = new CookingController();
		inputAmountCornPanel = this;
		...
		btnAmount.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				inputAmount.setText("");
				int modifyCropAmount = cookingController.modifyCropAmount(userNo, 2, intAmount);
				int modifyFoodAmount = cookingController.modifyFoodAmount(userNo, 2, intAmount);
				SuccessCookingPanel successCookingPanel = new SuccessCookingPanel(userNo);
				FrameManager.changePanel(inputAmountCornPanel, successCookingPanel);
			}
		});
	}
}
