...
private JPanel garlicResultPanel;
	...
	public GarlicResultPanel(int userNo) {
		...
		JLabel garlicPriceLabel = new JLabel("마늘 씨앗의 가격은 3천원 입니다!");
		...
		btnCancel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(garlicResultPanel, buySeedListPanel);
		...
		btnBack.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(garlicResultPanel, FarmPanel);
