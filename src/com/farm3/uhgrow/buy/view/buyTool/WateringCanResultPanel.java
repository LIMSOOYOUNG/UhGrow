...
public class WateringCanResultPanel extends JPanel{
	...
	public WateringCanResultPanel(int userNo) {
		...
		JLabel wateringCanPriceLabel = new JLabel("물뿌리개의 가격은 32만원 입니다!");
		wateringCanPriceLabel.setBounds(250, 165, 700, 50);
		wateringCanPriceLabel.setFont(font);
		
		this.add(wateringCanPriceLabel);
