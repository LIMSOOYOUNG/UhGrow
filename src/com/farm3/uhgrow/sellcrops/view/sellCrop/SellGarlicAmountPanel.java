...
public class SellGarlicAmountPanel extends JPanel{
	...
	public SellGarlicAmountPanel(int userNo) {
		...
		JLabel garlicPriceLabel = new JLabel("마늘의 판매가격은 440원 입니다!");
		garlicPriceLabel.setBounds(230, 165, 700, 40);
		garlicPriceLabel.setFont(font);
		...
		btnCancel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(sellGarlicAmountPanel, sellCropListPanel);
		...
		btnBack.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(sellGarlicAmountPanel, FarmPanel);
