...
public class SellPumpkinAmountPanel extends JPanel {
	...
	public SellPumpkinAmountPanel(int userNo) {
		...
		JLabel pumpkinPriceLabel = new JLabel("호박의 판매가격은 1700원 입니다!");
		...
		btnCancel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(sellPumpkinAmountPanel, sellCropListPanel);
		...
		btnBack.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				FrameManager.changePanel(sellPumpkinAmountPanel, FarmPanel);
