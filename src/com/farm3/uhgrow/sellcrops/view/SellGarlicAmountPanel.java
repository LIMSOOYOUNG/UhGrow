	...
	public SellGarlicAmountPanel() {
		...
		confirmButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				List<CropDTO> userCropList = sellController.userGarlicList();
				...
				if (sellAmount> 0 && sellAmount <= garlicAmount && garlicAmount != 0) {
					...
					updateUserGarlicAmount = sellController.updateUserGarlicAmount(sellAmount);
					
					getPrice = sellController.sellGarlicGetCoin(sellAmount, garlicPrice);
